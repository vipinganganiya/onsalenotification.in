...
class ClubsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Data Rows
        $postDataType = DataType::where('slug', 'clubs')->firstOrFail();
        ...
        $dataRow = $this->dataRow($postDataType, 'club_belongs_to_user_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
        ...
        Permission::firstOrCreate(['key' => 'publish_clubs', 'table_name' => 'clubs']);
    }
