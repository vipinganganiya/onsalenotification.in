...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permissions', 'permission_role', 'personal_access_tokens', 'translations', 'settings', 'user_roles', 'failed_jobs'],
        ],
    ...
    */
    ...
    'additional_css' => [
        '/public/css/event_notification.css',
    ],
