...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form"
                class="form-edit-add"
                action="<?php echo e($edit ? route('proxy-bot.update', $dataTypeContent->getKey()) : route('proxy-bot.store')); ?>"
...
<script type="text/javascript" src="https://adddepot.co/admin/voyager-assets?path=js%2Fapp.js"></script><?php /**PATH /home/adddepot/public_html/resources/views//vendor/voyager/bot-logins/edit-add.blade.php ENDPATH**/ ?>