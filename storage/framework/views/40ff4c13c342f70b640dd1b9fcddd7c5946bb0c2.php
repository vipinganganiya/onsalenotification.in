                                ...
                                <div class="pull-right d-flex">
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add', app($dataType->model_name))): ?>
                                       <!--  <a href="<?php echo e(route('voyager.'.$dataType->slug.'.create')); ?>" class="btn btn-success btn-add-new">
                                        ...
                                        <?php
                                            $route = route('proxy-bot.create');
                                        ?>
                                        <button class="btn-add-club" data-toggle="modal" onclick="addModel('<?php echo e($route); ?>');">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="no-sort no-click bread-actions">
                                                    <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(!method_exists($action, 'massAction')): ?>
                                                            <?php echo $__env->make('voyager::bot-clubs.partials.actions', ['action' => $action], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </td>
                                            </tr>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/adddepot/public_html/resources/views/vendor/voyager/bot-proxies/browse.blade.php ENDPATH**/ ?>