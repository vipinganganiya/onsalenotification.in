    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($action->getPolicy(), $data)): ?>
        <?php if($action->shouldActionDisplayOnRow($data)): ?>
            <?php if($action->getTitle() == "View"): ?>
                <a href="#" title="<?php echo e($action->getTitle()); ?>" <?php echo $action->convertAttributesToHtml(); ?> onclick="editProfile('machines/read/<?php echo e($data->id); ?>');">
            ...
            <?php else: ?>
                <a href="#" title="<?php echo e($action->getTitle()); ?>" <?php echo $action->convertAttributesToHtml(); ?> onclick="editProfile('<?php echo e($action->getRoute($dataType->name)); ?>')">
                    <i class="<?php echo e($action->getIcon()); ?>"></i> 
                    </span>
                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                <!-- <span class="icon-stats">
...
<?php endif; ?><?php /**PATH /home/adddepot/public_html/resources/views/vendor/voyager/bot-machines/partials/actions.blade.php ENDPATH**/ ?>