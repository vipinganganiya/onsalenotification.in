...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form"
                class="form-edit-add"
                action="<?php echo e($edit ? route('clubs-bot.update', $dataTypeContent->getKey()) : route('clubs-bot.store')); ?>"
            ...
            <div class="form-group">
                ...
                <?php if($errors->has('club_name')): ?>
                    <span class="text-danger"><?php echo e($errors->first('club_name')); ?></span>
                <?php endif; ?>
...
<script type="text/javascript" src="http://onsalenotification.in/admin/voyager-assets?path=js%2Fapp.js"></script><?php /**PATH /home/adddepot/public_html/resources/views//vendor/voyager/bot-proxies/edit-add.blade.php ENDPATH**/ ?>