    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($action->getPolicy(), $data)): ?>
        <?php if($action->shouldActionDisplayOnRow($data)): ?>
            <?php if($action->getTitle() == "View"): ?>
                <a href="#" title="<?php echo e($action->getTitle()); ?>" <?php echo $action->convertAttributesToHtml(); ?> onclick="editProfile('clubs/read/<?php echo e($data->id); ?>');">
...
<?php endif; ?><?php /**PATH /home/adddepot/public_html/resources/views/vendor/voyager/bot-clubs/partials/actions.blade.php ENDPATH**/ ?>