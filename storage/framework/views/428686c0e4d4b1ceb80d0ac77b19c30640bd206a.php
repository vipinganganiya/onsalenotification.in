...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form"
                class="form-edit-add"
                action="<?php echo e($edit ? route('machines.update', $dataTypeContent->getKey()) : route('machines.store')); ?>"
...
<script type="text/javascript" src="http://onsalenotification.in/admin/voyager-assets?path=js%2Fapp.js"></script><?php /**PATH /home/adddepot/public_html/resources/views//vendor/voyager/bot-machines/edit-add.blade.php ENDPATH**/ ?>